void br3()
{
    ...
    TH1F* histogram = new TH1F("histogram", "Electron_pt_2_Histogram", 39, 0,276.9);
    // Create a variable to hold the branch data
    float Electron_pt_2 = 0.0;
    // Set the branch address to the variable
    t1->SetBranchAddress("Electron_pt_2", &Electron_pt_2);
