void br0()
{
    ...
    TH1F* histogram = new TH1F("histogram", "Muon_pt_1_Histogram", 39, 0,276.9);
    // Create a variable to hold the branch data
    float Muon_pt_1 = 0.0;
    // Set the branch address to the variable
    t1->SetBranchAddress("Muon_pt_1", &Muon_pt_1);
