void br7()
{
    ...
    TH1F* histogram = new TH1F("histogram", "dPhim2e2_Histogram", 39, 0,10);
    // Create a variable to hold the branch data
    float dPhim2e2 = 0.0;
    // Set the branch address to the variable
    t1->SetBranchAddress("dPhim2e2", &dPhim2e2);
