void br10()
{
    ...
    TH1F* histogram = new TH1F("histogram", "Muon_eta_1_Histogram", 39, -3,4);
    // Create a variable to hold the branch data
    float Muon_eta_1 = 0.0;
    // Set the branch address to the variable
    t1->SetBranchAddress("Muon_eta_1", &Muon_eta_1);
