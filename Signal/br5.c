void br5()
{
    ...
    TH1F* histogram = new TH1F("histogram", "dPhim1e2_Histogram", 30, -5, 5);
    // Create a variable to hold the branch data
    float dPhim1e2 = 0.0;
    // Set the branch address to the variable
    t1->SetBranchAddress("dPhim1e2", &dPhim1e2);
