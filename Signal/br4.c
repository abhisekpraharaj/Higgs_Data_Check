void br4()
{
    ...
    TH1F* histogram = new TH1F("histogram", "dPhim1e1_Histogram", 40,-3,3);
    // Create a variable to hold the branch data
    float dPhim1e1 = 0.0;
    // Set the branch address to the variable
    t1->SetBranchAddress("dPhim1e1", &dPhim1e1);
