void br9()
{
    ...
    TH1F* histogram = new TH1F("histogram", "Electron_eta_2_Histogram", 39, -3,4);
    // Create a variable to hold the branch data
    float Electron_eta_2 = 0.0;
    // Set the branch address to the variable
    t1->SetBranchAddress("Electron_eta_2", &Electron_eta_2);
