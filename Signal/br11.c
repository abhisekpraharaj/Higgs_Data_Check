void br11()
{
    ...
    TH1F* histogram = new TH1F("histogram", "Muon_eta_2_Histogram", 39, -3,4);
    // Create a variable to hold the branch data
    float Muon_eta_2 = 0.0;
    // Set the branch address to the variable
    t1->SetBranchAddress("Muon_eta_2", &Muon_eta_2);
