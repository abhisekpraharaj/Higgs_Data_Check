void r1()
{
    ...
    TH1F *sh = new TH1F("sh", "Muon_pt_2_signal_histogram", 39, 0, 296.9);
    TH1F *bh = new TH1F("bh", "Muon_pt_2_background_histogram", 39, 0, 296.9);

    st->Draw("Muon_pt_2>>sh");
    bt->Draw("Muon_pt_2>>bh");
